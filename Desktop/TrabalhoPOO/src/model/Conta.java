...
public class Conta {
    ...
    public ArrayList<Lancamento> listarTudo() {
        ArrayList<Lancamento> receita = new ArrayList<>();
        for (Lancamento lancamento : this.lancamento) {
            receita.add(lancamento);
        }
    ...
    public ArrayList<Lancamento> listarLancamentoOrdenados() {
        ArrayList<Lancamento> lancamentosOrdenados = new ArrayList(lancamento);
        Collections.sort(lancamentosOrdenados, new DataOrdenador());
